...
const plugin = (options = {}) => {
    ...
    return {
        ...
        resolveId(source, importer) {
            ...
            const isIncluded = (module) => { var _a; return include && ((_a = module.packageId) === null || _a === void 0 ? void 0 : _a.name) && include.find(i => { var _a; return ((_a = module.packageId) === null || _a === void 0 ? void 0 : _a.name) == i; }); };
            if ((!respectExternal && resolvedModule.isExternalLibraryImport) && !isIncluded(resolvedModule)) {
                ...
                ((_a = resolvedModule.packageId) === null || _a === void 0 ? void 0 : _a.name) && console.log(`>>> module ${(_b = resolvedModule.packageId) === null || _b === void 0 ? void 0 : _b.name} will be resolved from ${resolvedModule.resolvedFileName}`);
