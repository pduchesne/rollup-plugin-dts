...
const plugin = (options = {}) => {
    ...
    return {
        ...
        resolveId(source, importer) {
            ...
            const isIncluded = (module) => ctx.resolvedOptions.include && module.packageId?.name && ctx.resolvedOptions.include.find(i => module.packageId?.name == i);
            if ((!ctx.resolvedOptions.respectExternal && resolvedModule.isExternalLibraryImport) && !isIncluded(resolvedModule)) {
